...
Team_Government = DarkRP.createJob("Judge", {
    ...
    weapons = {"ephone", "weapon_arc_atmcard", "med_kit", "weapon_deagle2", "arrest_stick", "unarrest_stick"},
    command = "Judge",
    max = 1,
    salary = 500,
    admin = 0,
...
Team_Civilian = DarkRP.createJob("Citizen", {
    ...
    weapons = {"ephone", "weapon_arc_atmcard"},
    command = "Civilian",
    max = 0,
    salary = 90,
    admin = 0,
...
Team_Government = DarkRP.createJob("Mayor", {
    ...
    weapons = {"ephone", "weapon_arc_atmcard", "weapon_deagle2"},
    command = "Mayor",
    max = 1,
    salary = 300,
    admin = 0,
...
Team_City_Police = DarkRP.createJob("Police Officer", {
    ...
    weapons = {"ephone", "weapon_arc_atmcard", "weapon_glock2", "arrest_stick", "unarrest_stick", "stunstick"},
...
Team_City_Police = DarkRP.createJob("Detective", {
    ...
    weapons = {"ephone", "weapon_arc_atmcard", "weapon_glock2", "arrest_stick", "unarrest_stick", "stunstick", "weapon_pumpshotgun2", "lockpick"},
    command = "Detective",
    max = 4,
    salary = 200,
    admin = 0,
...
Team_First_Responder = DarkRP.createJob("EMT", {
    ...
    weapons = {"ephone", "weapon_arc_atmcard", "med_kit"},
    command = "EMT",
    max = 4,
    salary = 200,
    admin = 0,
...
TEAM_Criminal = DarkRP.createJob("Thief ", {
    ...
    weapons = {"ephone", "weapon_arc_atmcard", "lockpick"},
    command = "Thief",
    max = 4,
    salary = 100,
    admin = 0,
...
TEAM_Hatchet_Family = DarkRP.createJob("Hatchet Family Guard", {
    ...
    weapons = {"ephone", "weapon_arc_atmcard", "lockpick", "stunstick"},
    command = "Guard",
    max = 6,
    salary = 100,
    admin = 0,
...
TEAM_Hatchet_Family = DarkRP.createJob("Tony Hatchet", {
    ...
    weapons = {"ephone", "weapon_arc_atmcard", "lockpick", "stunstick", "weapon_deagle2", "weapon_ak472"},
